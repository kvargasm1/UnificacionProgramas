...
public class PruebaSeries {
	...
	public void prueba(Double vec[],int n,double alfa,int periodo)
	{
		...
		if(x02<xn2)
        {
                       ...
                       JOptionPane.showMessageDialog(null, "El criterio es aceptado");
        }
		else{

                     JOptionPane.showMessageDialog(null, "El criterio no es aceptado");
        }
